const Header = () => {
  return (
    <header className="flex justify-between items-center bg-blue-500 w-full h-16">
      <div
        className="w-[76px] h-[46px] flex justify-center items-center flex-col ml-[26px] rounded-[5px] border-[3px] border-solid border-[white]"
